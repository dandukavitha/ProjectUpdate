  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li ><a href="Women">Home Appliances</a></li>
<li><a href="CustomerCheck">Login</a></li>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="resources/images/k15.png" alt="Chania" style="width:800px; height:400px">
      ...
      <div class="item">
        <img src="resources/images/k11.jpg" alt="Chania" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!-- <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something"> -->
   ...
   <div class="item">
      ...
      <div class="item">
        <img src="resources/images/k12.jpg" alt="Flower" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!--  <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something">-->
      ...
      <div class="item">
        <img src="resources/images/k13.jpg" alt="Flower" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!-- <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something">-->
